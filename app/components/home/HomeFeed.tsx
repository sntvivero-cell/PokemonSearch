...
// Extraído de app/page.tsx (SEO): un Client Component no puede exportar `metadata` en
// el App Router, así que page.tsx quedó como un wrapper de Server Component que solo
// exporta metadata específica del feed y renderiza esto — toda la lógica/interactividad
// original se mueve acá sin cambios.
